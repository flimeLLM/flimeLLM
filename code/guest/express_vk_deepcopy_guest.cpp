...
// Autogenerated module express_vk_deepcopy_guest
//
...
void deepcopy_VkBaseInStructure(Allocator* alloc, VkStructureType rootType,
    ...
    *to = *from;
    ...
    while (!pNext_size && from_pNext) {
        ...
        pNext_size = express_vk_extension_struct_size(rootType, from_pNext);
    }
    to->pNext = nullptr;
    if (pNext_size) {
...
void deepcopy_VkInstanceCreateInfo(Allocator* alloc, VkStructureType rootType,
    ...
    *to = *from;
    ...
    if (from->pApplicationInfo) {
        ...
        ALOGI("has vulkan application info %d", to->pApplicationInfo->sType);
    }
...
void deepcopy_VkPresentInfoKHR(Allocator* alloc, VkStructureType rootType,
    ...
    *to = *from;
    ...
    to->pResults = nullptr;
    if (from->pResults) {
        to->pResults = (VkResult*)alloc->dupArray(
            from->pResults, from->swapchainCount * sizeof(VkResult));
    }
}
