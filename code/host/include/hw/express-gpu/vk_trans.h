...
/*
 * Serializes native descriptor realization, FLIME submit admission, queue
 * submission, and Vulkan object destruction.  Destructive transport cleanup
 * must acquire this mutex before the FLIME bridge lock.
 */
extern GMutex g_express_vk_transaction_lock;
...
/* Express host-extension protocol IDs shared with newer guests. */
